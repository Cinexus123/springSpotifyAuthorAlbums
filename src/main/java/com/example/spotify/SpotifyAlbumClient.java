...
import com.example.spotify.model.SpotifyAlbum;
import com.example.spotify.model.dto.SpotifyAlbumDto;
...
public class SpotifyAlbumClient {
    ...
    public List<SpotifyAlbumDto> getAlbumsByAuthor(OAuth2Authentication details, @PathVariable String authorName) {
        ...
        List<SpotifyAlbumDto> spotifyAlbumDtos = exchange.getBody()
